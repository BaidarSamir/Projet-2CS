  ...
  const getPrediction = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/get_prediction?filename=${encodeURIComponent(
          filename
        )}&shots=${selectedShots}`
      );
      ...
      if (!response.ok) {
        throw new Error(
          'Classification data not found for this satellite image'
        );
      }
      ...
      setError(
        err instanceof Error
          ? err.message
          : 'Failed to classify satellite imagery'
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-600'>
            Few-Shot Learning for Land Use & Land Cover Analysis
          </p>
        </div>
                ...
                {!selectedFile ? (
                  <div className='text-center'>
                    ...
                    <p className='text-gray-600 mb-4'>
                      Drag and drop your remote sensing image here, or click to
                      browse
                    </p>
                    <p className='text-sm text-gray-500 mb-6'>
                      Supports: Landsat, Sentinel, aerial imagery, and other
                  ...
                  <div className='space-y-4'>
                    ...
                    {!prediction && (
                      ...
                      >
                        ...
                        {loading
                          ? 'Analyzing Imagery...'
                          : `Classify with ${selectedShots}-Shot Learning`}
                      </Button>
                    )}
                  </div>
                )}
                ...
                <CardContent>
                    ...
                    <div className='space-y-6'>
                      ...
                      <div className='flex items-center gap-3 p-4 rounded-lg border-2 border-dashed border-gray-200 bg-gray-50'>
                        ...
                        <div>
                          <Badge
                            variant={
                              prediction.correct ? 'default' : 'destructive'
                            }
                            className={`text-sm ${
                              prediction.correct ? 'bg-green-600' : 'bg-red-600'
                            }`}
                          >
                            {prediction.correct
                      ...
                      <div className='grid md:grid-cols-2 gap-4'>
                        <div
                          className={`p-4 rounded-lg border-2 ${getClassColor(
                        ...
                        >
                          ...
                          <p className='text-xl font-bold'>
                            {formatClassName(prediction.true_class)}
                          </p>
                      ...
                      <div className='space-y-3'>
                        ...
                        <p className='text-sm text-gray-600'>
                          Model certainty in land cover classification
                        </p>
                      </div>
                  ...
                  {!loading && !error && !prediction && selectedFile && (
                    <div className='text-center text-gray-500 py-8'>
                      ...
                      <p>
                        Click "Classify Land Cover" to analyze your satellite
                        imagery
                      </p>
                    </div>
                  )}
